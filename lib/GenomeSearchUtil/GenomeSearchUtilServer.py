...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'GenomeSearchUtil'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from GenomeSearchUtil.GenomeSearchUtilImpl import GenomeSearchUtil  # noqa @IgnorePep8
impl_GenomeSearchUtil = GenomeSearchUtil(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_GenomeSearchUtil.search,
                             ...
                             types=[dict])
        self.method_authentication['GenomeSearchUtil.search'] = 'optional'  # noqa
        self.rpc_service.add(impl_GenomeSearchUtil.search_region,
                             name='GenomeSearchUtil.search_region',
                             types=[dict])
        self.method_authentication['GenomeSearchUtil.search_region'] = 'optional'  # noqa
        self.rpc_service.add(impl_GenomeSearchUtil.search_contigs,
                             name='GenomeSearchUtil.search_contigs',
                             types=[dict])
        self.method_authentication['GenomeSearchUtil.search_contigs'] = 'optional'  # noqa
