...
from GenomeSearchUtil.GenomeSearchUtilImpl import GenomeSearchUtil  # @IgnorePep8
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_GenomeSearchUtil.search,
                             ...
                             types=[dict])
        self.method_authentication['GenomeSearchUtil.search'] = 'optional'
                ...
                try:
                    ...
                    if auth_req != 'none':
                        if token is None and auth_req == 'required':
                            err = JSONServerError()
                            err.data = (
                                'Authentication required for GenomeSearchUtil ' +
