...
function GenomeSearchUtil(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.search = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeSearchUtil.search",
     ...
     this.search_region = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "GenomeSearchUtil.search_region",
            [params], 1, _callback, _errorCallback);
    };
     ...
     this.search_contigs = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "GenomeSearchUtil.search_contigs",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "GenomeSearchUtil.status",
